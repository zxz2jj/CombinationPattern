...
def get_neural_value_and_average(source_path, number_of_neuron, number_of_classes):
    ...
    :param
    :return:  correct_neural_value[]  non_class_l_average[]
    """
...
if __name__ == "__main__":
    correct_south_path = "/Users/zz/PycharmProjects/fashionMnist/MNIST_data/training_data/correct_neural_value/fc1"
    coding_examples_path = "/Users/zz/PycharmProjects/fashionMnist/MNIST_data/testing_data/wrong_to_neural_value/fc1"
    non_class_l_avg, all_class_avg = get_neural_value_and_average(correct_south_path, 256, 10)
