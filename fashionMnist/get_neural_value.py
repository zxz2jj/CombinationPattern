...
# 计算预测正确训练集图片的神经元输出
for i in range(10):
    Source_path = r'/Users/zz/PycharmProjects/fashionMnist/MNIST_data/testing_data/wrong_prediction_to_' + str(i) + \
                  '.txt'
    ...
    # 第五层全连接层输出
    Result_path = r'/Users/zz/PycharmProjects/fashionMnist/MNIST_data/testing_data/wrong_to_neural_value/fc1/' + \
    ...
    # 第六层全连接层输出
    Result_path = r'/Users/zz/PycharmProjects/fashionMnist/MNIST_data/testing_data/wrong_to_neural_value/fc2/' + \
                  'wrong_to_' + str(i) + 'NeuralValue.txt'
    get_neural_value(source_path=Source_path, result_path=Result_path,
