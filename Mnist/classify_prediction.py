...
sourcePath = r"/Users/zz/PycharmProjects/Mnist/MNIST_data/testing_data/"
f_test_0 = open(sourcePath + r"wrong_prediction_to_0.txt", 'w')
f_test_1 = open(sourcePath + r"wrong_prediction_to_1.txt", 'w')
f_test_2 = open(sourcePath + r"wrong_prediction_to_2.txt", 'w')
f_test_3 = open(sourcePath + r"wrong_prediction_to_3.txt", 'w')
f_test_4 = open(sourcePath + r"wrong_prediction_to_4.txt", 'w')
f_test_5 = open(sourcePath + r"wrong_prediction_to_5.txt", 'w')
f_test_6 = open(sourcePath + r"wrong_prediction_to_6.txt", 'w')
f_test_7 = open(sourcePath + r"wrong_prediction_to_7.txt", 'w')
f_test_8 = open(sourcePath + r"wrong_prediction_to_8.txt", 'w')
f_test_9 = open(sourcePath + r"wrong_prediction_to_9.txt", 'w')
...
for target in range(10):
    ...
    with open(sourcePath + r"test_images_class_" + str(target)+".txt", 'r') as f:
        data = f.read()
        images = []
        numlist = data.split()
    ...
    f_c = open(sourcePath + r'class' + str(target)+'_correct_prediction.txt', 'w')
    f_w = open(sourcePath + r'class' + str(target)+'_wrong_prediction.txt', 'w')
